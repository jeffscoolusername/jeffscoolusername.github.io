...
.ready(function() {
    ...
    tb251,tb252,tb253,tb254,tb255,tb256,tb257,tb258,tb259,tb260,tb261,tb262,tb263,tb264,tb265,tb266,tb267,tb268,tb269,tb270,tb271,tb272,tb273,tb274,tb275,tb276,
    tb277,tb278,tb279 = 'loading';
    ...
    getJSON(url32,async function(err, data32) {tb256 = data32.asset.params['unit-name'];tb257 = data32.asset['index'];tb258 = data32.asset['created-at-round'];
    ...
    getJSON(url33,async function(err, data33) {tb264 = data33.asset.params['unit-name'];tb265 = data33.asset['index'];tb266 = data33.asset['created-at-round'];
    ...
    getJSON(url34,async function(err, data34) {tb272 = data34.asset.params['unit-name'];tb273 = data34.asset['index'];tb274 = data34.asset['created-at-round'];
    tb275 = data34.asset.params['name'];tb276 = data34.asset['asset-tx-counter'];tb277 = data34.asset.params['circulating-supply'];
    tb278 = data34.asset.params['total'];tb279 = ((data34.asset.params['circulating-supply']/data34.asset.params['total'])*100).toFixed(6);})
        
        
        getJSON(url35,async function(err, data35) {getJSON(url36,
    ...
    var jsObj = [
      ...
      {'Element':'34','Unit Name': tb272,'ID': tb273,'Created at Round': tb274,'Name': tb275,'Transactions Counter': tb276,'Circulating Supply': tb277,
      'Total Supply': tb278,'% in Circulation': tb279},
