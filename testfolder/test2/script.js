...
.ready(function() {
    ...
    tb14 = data1.asset.params['total'];tb15 = ((data1.asset.params['circulating-supply']/data1.asset.params['total'])*100).toFixed(3);})            
    ...
    tb22 = data2.asset.params['total'];tb23 = ((data2.asset.params['circulating-supply']/data2.asset.params['total'])*100).toFixed(3);})                
    ...
    tb30 = data3.asset.params['total'];tb31 = ((data3.asset.params['circulating-supply']/data3.asset.params['total'])*100).toFixed(3);})                      
    ...
    tb38 = data4.asset.params['total'];tb39 = ((data4.asset.params['circulating-supply']/data4.asset.params['total'])*100).toFixed(3);})  
    ...
    tb46 = data5.asset.params['total'];tb47 = (data5.asset.params['circulating-supply']/data5.asset.params['total']).toFixed(3);})          
    ...
    tb54 = data6.asset.params['total'];tb55 = (data6.asset.params['circulating-supply']/data6.asset.params['total']).toFixed(3);})   
    ...
    tb62 = data7.asset.params['total'];tb63 = (data7.asset.params['circulating-supply']/data7.asset.params['total']).toFixed(3);})
    ...
    tb70 = data8.asset.params['total'];tb71 = (data8.asset.params['circulating-supply']/data8.asset.params['total']).toFixed(3);})
    ...
    tb78 = data9.asset.params['total'];tb79 = (data9.asset.params['circulating-supply']/data9.asset.params['total']).toFixed(3);})
    ...
    tb86 = data10.asset.params['total'];tb87 = (data10.asset.params['circulating-supply']/data10.asset.params['total']).toFixed(3);})
    ...
    tb94 = data11.asset.params['total'];tb95 = (data11.asset.params['circulating-supply']/data11.asset.params['total']).toFixed(3);})
    ...
    tb102 = data12.asset.params['total'];tb103 = (data12.asset.params['circulating-supply']/data12.asset.params['total']).toFixed(3);})
    ...
    tb110 = data13.asset.params['total'];tb111 = (data13.asset.params['circulating-supply']/data13.asset.params['total']).toFixed(3);})
    ...
    tb118 = data14.asset.params['total'];tb119 = (data14.asset.params['circulating-supply']/data14.asset.params['total']).toFixed(3);})
    ...
    tb126 = data15.asset.params['total'];tb127 = (data15.asset.params['circulating-supply']/data15.asset.params['total']).toFixed(3);})
    ...
    tb134 = data16.asset.params['total'];tb135 = (data16.asset.params['circulating-supply']/data16.asset.params['total']).toFixed(3);})
    ...
    tb142 = data17.asset.params['total'];tb143 = (data17.asset.params['circulating-supply']/data17.asset.params['total']).toFixed(3);})
    ...
    tb150 = data18.asset.params['total'];tb151 = (data18.asset.params['circulating-supply']/data18.asset.params['total']).toFixed(3);})
    ...
    tb158 = data19.asset.params['total'];tb159 = (data19.asset.params['circulating-supply']/data19.asset.params['total']).toFixed(3);})
    ...
    tb166 = data20.asset.params['total'];tb167 = (data20.asset.params['circulating-supply']/data20.asset.params['total']).toFixed(3);})
    ...
    tb174 = data21.asset.params['total'];tb175 = (data21.asset.params['circulating-supply']/data21.asset.params['total']).toFixed(3);})
    ...
    tb182 = data22.asset.params['total'];tb183 = (data22.asset.params['circulating-supply']/data22.asset.params['total']).toFixed(3);})
    ...
    tb190 = data23.asset.params['total'];tb191 = (data23.asset.params['circulating-supply']/data23.asset.params['total']).toFixed(3);})
    ...
    tb198 = data24.asset.params['total'];tb199 = (data24.asset.params['circulating-supply']/data24.asset.params['total']).toFixed(3);})
    ...
    tb206 = data25.asset.params['total'];tb207 = (data25.asset.params['circulating-supply']/data25.asset.params['total']).toFixed(3);})
    ...
    tb214 = data26.asset.params['total'];tb215 = (data26.asset.params['circulating-supply']/data26.asset.params['total']).toFixed(3);})
    ...
    tb222 = data27.asset.params['total'];tb223 = (data27.asset.params['circulating-supply']/data27.asset.params['total']).toFixed(3);})
    ...
    tb230 = data28.asset.params['total'];tb231 = (data28.asset.params['circulating-supply']/data28.asset.params['total']).toFixed(3);})
    ...
    tb238 = data29.asset.params['total'];tb239 = (data29.asset.params['circulating-supply']/data29.asset.params['total']).toFixed(3);})
    ...
    tb246 = data30.asset.params['total'];tb247 = (data30.asset.params['circulating-supply']/data30.asset.params['total']).toFixed(3);})
    ...
    tb254 = data31.asset.params['total'];tb255 = (data31.asset.params['circulating-supply']/data31.asset.params['total']).toFixed(3);})
    ...
    var jsObj = [
      ...
      'Total Supply': data32.asset.params['total'], '% in Circulation': (data32.asset.params['circulating-supply']/data32.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data33.asset.params['total'], '% in Circulation': (data33.asset.params['circulating-supply']/data33.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data34.asset.params['total'], '% in Circulation': (data34.asset.params['circulating-supply']/data34.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data35.asset.params['total'], '% in Circulation': (data35.asset.params['circulating-supply']/data35.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data36.asset.params['total'], '% in Circulation': (data36.asset.params['circulating-supply']/data36.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data37.asset.params['total'], '% in Circulation': (data37.asset.params['circulating-supply']/data37.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data38.asset.params['total'], '% in Circulation': (data38.asset.params['circulating-supply']/data38.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data39.asset.params['total'], '% in Circulation': (data39.asset.params['circulating-supply']/data39.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data40.asset.params['total'], '% in Circulation': (data40.asset.params['circulating-supply']/data40.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data41.asset.params['total'], '% in Circulation': (data41.asset.params['circulating-supply']/data41.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data42.asset.params['total'], '% in Circulation': (data42.asset.params['circulating-supply']/data42.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data43.asset.params['total'], '% in Circulation': (data43.asset.params['circulating-supply']/data43.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data44.asset.params['total'], '% in Circulation': (data44.asset.params['circulating-supply']/data44.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data45.asset.params['total'], '% in Circulation': (data45.asset.params['circulating-supply']/data45.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data46.asset.params['total'], '% in Circulation': (data46.asset.params['circulating-supply']/data46.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data47.asset.params['total'], '% in Circulation': (data47.asset.params['circulating-supply']/data47.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data48.asset.params['total'], '% in Circulation': (data48.asset.params['circulating-supply']/data48.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data49.asset.params['total'], '% in Circulation': (data49.asset.params['circulating-supply']/data49.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data50.asset.params['total'], '% in Circulation': (data50.asset.params['circulating-supply']/data50.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data51.asset.params['total'], '% in Circulation': (data51.asset.params['circulating-supply']/data51.asset.params['total']).toFixed(3) + '%'},
      ...
      'Total Supply': data52.asset.params['total'], '% in Circulation': (data52.asset.params['circulating-supply']/data52.asset.params['total']).toFixed(3) + '%'}];            
