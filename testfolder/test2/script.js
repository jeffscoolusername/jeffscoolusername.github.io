...
.ready(function() {
    ...
    function(err, data52) { 
        //' = ' + (data0.asset.params['circulating-supply']/data0.asset.params['total'])*100).toFixed(2) + '%'
    var jsObj = [
      ...
      'Total Supply': data0.asset.params['total'], '% in Circulation': ((data0.asset.params['circulating-supply']/data0.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data1.asset.params['total'], '% in Circulation': ((data1.asset.params['circulating-supply']/data1.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data2.asset.params['total'], '% in Circulation': ((data2.asset.params['circulating-supply']/data2.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data3.asset.params['total'], '% in Circulation': ((data3.asset.params['circulating-supply']/data3.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data4.asset.params['total'], '% in Circulation': ((data4.asset.params['circulating-supply']/data4.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data5.asset.params['total'], '% in Circulation': ((data5.asset.params['circulating-supply']/data5.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data6.asset.params['total'], '% in Circulation': ((data6.asset.params['circulating-supply']/data6.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data7.asset.params['total'], '% in Circulation': ((data7.asset.params['circulating-supply']/data7.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data8.asset.params['total'], '% in Circulation': ((data8.asset.params['circulating-supply']/data8.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data9.asset.params['total'], '% in Circulation': ((data9.asset.params['circulating-supply']/data9.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data10.asset.params['total'], '% in Circulation': ((data10.asset.params['circulating-supply']/data10.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data11.asset.params['total'], '% in Circulation': ((data11.asset.params['circulating-supply']/data11.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data12.asset.params['total'], '% in Circulation': ((data12.asset.params['circulating-supply']/data12.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data13.asset.params['total'], '% in Circulation': ((data13.asset.params['circulating-supply']/data13.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data14.asset.params['total'], '% in Circulation': ((data14.asset.params['circulating-supply']/data14.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data15.asset.params['total'], '% in Circulation': ((data15.asset.params['circulating-supply']/data15.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data16.asset.params['total'], '% in Circulation': ((data16.asset.params['circulating-supply']/data16.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data17.asset.params['total'], '% in Circulation': ((data17.asset.params['circulating-supply']/data17.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data18.asset.params['total'], '% in Circulation': ((data18.asset.params['circulating-supply']/data18.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data19.asset.params['total'], '% in Circulation': ((data19.asset.params['circulating-supply']/data19.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data20.asset.params['total'], '% in Circulation': ((data20.asset.params['circulating-supply']/data20.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data21.asset.params['total'], '% in Circulation': ((data21.asset.params['circulating-supply']/data21.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data22.asset.params['total'], '% in Circulation': ((data22.asset.params['circulating-supply']/data22.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data23.asset.params['total'], '% in Circulation': ((data23.asset.params['circulating-supply']/data23.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data24.asset.params['total'], '% in Circulation': ((data24.asset.params['circulating-supply']/data24.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data25.asset.params['total'], '% in Circulation': ((data25.asset.params['circulating-supply']/data25.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data26.asset.params['total'], '% in Circulation': ((data26.asset.params['circulating-supply']/data26.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data27.asset.params['total'], '% in Circulation': ((data27.asset.params['circulating-supply']/data27.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data28.asset.params['total'], '% in Circulation': ((data28.asset.params['circulating-supply']/data28.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data29.asset.params['total'], '% in Circulation': ((data29.asset.params['circulating-supply']/data29.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data30.asset.params['total'], '% in Circulation': ((data30.asset.params['circulating-supply']/data30.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data31.asset.params['total'], '% in Circulation': ((data31.asset.params['circulating-supply']/data31.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data32.asset.params['total'], '% in Circulation': ((data32.asset.params['circulating-supply']/data32.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data33.asset.params['total'], '% in Circulation': ((data33.asset.params['circulating-supply']/data33.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data34.asset.params['total'], '% in Circulation': ((data34.asset.params['circulating-supply']/data34.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data35.asset.params['total'], '% in Circulation': ((data35.asset.params['circulating-supply']/data35.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data36.asset.params['total'], '% in Circulation': ((data36.asset.params['circulating-supply']/data36.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data37.asset.params['total'], '% in Circulation': ((data37.asset.params['circulating-supply']/data37.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data38.asset.params['total'], '% in Circulation': ((data38.asset.params['circulating-supply']/data38.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data39.asset.params['total'], '% in Circulation': ((data39.asset.params['circulating-supply']/data39.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data40.asset.params['total'], '% in Circulation': ((data40.asset.params['circulating-supply']/data40.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data41.asset.params['total'], '% in Circulation': ((data41.asset.params['circulating-supply']/data41.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data42.asset.params['total'], '% in Circulation': ((data42.asset.params['circulating-supply']/data42.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data43.asset.params['total'], '% in Circulation': ((data43.asset.params['circulating-supply']/data43.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data44.asset.params['total'], '% in Circulation': ((data44.asset.params['circulating-supply']/data44.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data45.asset.params['total'], '% in Circulation': ((data45.asset.params['circulating-supply']/data45.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data46.asset.params['total'], '% in Circulation': ((data46.asset.params['circulating-supply']/data46.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data47.asset.params['total'], '% in Circulation': ((data47.asset.params['circulating-supply']/data47.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data48.asset.params['total'], '% in Circulation': ((data48.asset.params['circulating-supply']/data48.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data49.asset.params['total'], '% in Circulation': ((data49.asset.params['circulating-supply']/data49.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data50.asset.params['total'], '% in Circulation': ((data50.asset.params['circulating-supply']/data50.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data51.asset.params['total'], '% in Circulation': ((data51.asset.params['circulating-supply']/data51.asset.params['total'])*100).toFixed(2) + '%'},
      ...
      'Total Supply': data52.asset.params['total'], '% in Circulation': ((data52.asset.params['circulating-supply']/data52.asset.params['total'])*100).toFixed(2) + '%'}];            
