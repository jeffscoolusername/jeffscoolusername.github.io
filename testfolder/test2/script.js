...
.ready(function() {
    ...
    tb102 = data12.asset.params['total'];tb103 = (data12.asset.params['circulating-supply']/data12.asset.params['total']).toFixed(6);})
    ...
    tb110 = data13.asset.params['total'];tb111 = (data13.asset.params['circulating-supply']/data13.asset.params['total']).toFixed(6);})
    ...
    tb118 = data14.asset.params['total'];tb119 = (data14.asset.params['circulating-supply']/data14.asset.params['total']).toFixed(6);})
